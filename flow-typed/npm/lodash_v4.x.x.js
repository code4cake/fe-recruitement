// flow-typed signature: ebf49ac8aab1318f58f51cdae253b205
// flow-typed version: 4108b5dd7c/lodash_v4.x.x/flow_>=v0.104.x
...
declare module 'lodash' {
  ...
  declare class Lodash {
    ...
    pullAllWith<T: void | null>(array: T, values?: ?$ReadOnlyArray<any>, comparator?: ?Function): T;
    ...
    sortedUniqBy<T>(array?: ?$ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>): Array<T>;
    ...
    xorWith<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>, comparator?: Comparator<T>): Array<T>;
    xorWith<T>(
      a1: $ReadOnlyArray<T>,
      a2: $ReadOnlyArray<T>,
      a3: $ReadOnlyArray<T>,
    ...
    zipWith<T, A, B>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, iteratee: (A, B) => T): Array<T>;
    ...
    sampleSize<T>(
      collection?: ?$ReadOnlyArray<T> | $ReadOnly<{ [id: any]: T, ... }>,
      n?: ?number,
    ): Array<T>;
...
declare module 'lodash/fp' {
  ...
  declare class Lodash {
    ...
    sortedIndexBy<T>(iteratee: ValueOnlyIteratee<T>, value: T, array: $ReadOnlyArray<T>): number;
    ...
    unionWith<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
    uniq<T>(array: $ReadOnlyArray<T>): Array<T>;
