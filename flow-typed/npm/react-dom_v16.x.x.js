...
declare module 'react-dom' {
  ...
  declare function createPortal(node: React$Node, container: Element): React$Portal
  ...
  declare function unstable_renderSubtreeIntoContainer<ElementType: React$ElementType>(
...
declare module 'react-dom/test-utils' {
  ...
  declare function renderIntoDocument(instance: React$Element<any>): React$Component<any, any>
  ...
  declare function isCompositeComponent(instance: React$Component<any, any>): boolean
